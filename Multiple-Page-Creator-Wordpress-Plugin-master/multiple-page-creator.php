<?php
/*
*Plugin Name: Multiple Page Creator
*Plugin URI: https://moneysubsidiary.com
*Description: WordPress Multiple page creator 
*Version: 1.0
*Author: RK Singh, Money Subsidiary
*Author URI: https://moneysubsidiary.com
*License: GPLv2 2 or later
 */

//MPG stands for multiple page creator
...
{
    add_menu_page('Multiple Page Creator page', 'Multiple Page Creator', 'manage_options', 'mpg_plugin_menu', 'pageCreator', '', 2);
    add_submenu_page('mpg_plugin_menu', 'Single Inserter Page', 'Pages Creator', 'manage_options', 'single-creator', 'single_create');
    add_submenu_page('mpg_plugin_menu', 'Upload xlsx Page', 'Excel Sheet Pages Creator', 'manage_options', 'xlsx-page-creator', 'xlsx_page_create');
    remove_submenu_page('mpg_plugin_menu', 'mpg_plugin_menu');
}

function check_Yoast() {

    if (('multiple-page-creator_page_single-creator' || 'multiple-page-creator_page_xlsx-page-creator') != $hook) {
...
function mpg_enqueue($hook)
{
    ...
    if ('multiple-page-creator_page_xlsx-page-creator' === $hook) {
